...
export default function SideProfile() {
    ...
    return (
        <div className='w-full md:w-96 md:rounded-xl pb-10 bg-white drop-shadow-lg'>
            ...
            <div 
                className='flex items-center p-3 pl-5 mt-10 text-gray-500 hover:bg-gray-200'
            ...
            <div 
                className='flex items-center p-3 pl-5 text-gray-500 hover:bg-gray-200'
