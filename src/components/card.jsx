                  ...
                  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden-type-1">
                    ...
                    <div className="p-6 hover:bg-indigo-800 hover-text-white transition duration-300 ease-in">
                      ...
                      <p className="leading-relaxed mb-3">
                        Bali was inhabited by Austronesian people around 2000 BC
                        who migrated and came from Taiwan via Maritime Southeast
                        Asia. The culture and language of the Balinese are
                        closely related to the culture of the Indonesian
                        archipelago, Malaysia, the Philippines and Oceania.
                        Stone tools dating from this period have been found near
                        the village of Cekik on the western island of Bali.
                      </p>
                        ...
                        <svg
                          ...
                          <path
                            d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 
                                                ...
                                                8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z "></path>
                          <circle cx="12" cy="12" r="3"></circle>
                        </svg>
                        6
                      </span>
