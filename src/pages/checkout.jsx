          ...
          <div className="divide-y divide-slate-300 p-8 mx-10">
            ...
            <div className='mb-3'>
              ...
              <div className='flex mt-4 '>
                <img src='https://www.freepnglogos.com/uploads/logo-bca-png/bank-central-asia-logo-bank-central-asia-bca-format-cdr-png-gudril-1.png' className='w-14 h-15 ml-3'/>          
                <button className="ml-9" type="button">Virtual Account BCA</button> 
              </div>
            </div>
            <div className='flex mb-4 '> 
              <img src='https://prismalink.b-cdn.net/wp-content/uploads/2019/05/Cara-Transfer-Virtual-Account-Mandiri-Paling-Mudah.png' className='w-20 h-15 ml-3'/>          
            ...
            <div className='mb-3'>
              ...
              <div className='flex mt-4 '>
                <img src='https://upload.wikimedia.org/wikipedia/commons/9/9e/ALFAMART_LOGO_BARU.png' className='w-15 h-6 ml-3'/>
                  <span 
            ...
            <div className='flex mb-4 '>   
                        <img src='https://upload.wikimedia.org/wikipedia/commons/9/9d/Logo_Indomaret.png' className='w-15 h-6 ml-3'/>        
                              <button 
