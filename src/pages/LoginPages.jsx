                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                            ...
                            <div className='flex justify-center '>
                                ...
                                <button type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" className="inline-block mx-5 px-6 py-2.5 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" style={{backgroundColor: '#333'}}>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Don’t have an account yet? <span onClick={() => navigate('/register')} className="font-medium text-emerald-600 hover:underline">Sign up</span>
                            </p>
                        </form>
                    </div>
                </div>
